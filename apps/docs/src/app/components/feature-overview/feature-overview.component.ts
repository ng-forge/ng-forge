...
const FAQ: readonly FaqItem[] = [
  ...
  },
  {
    ...
    a: "Set `trigger: 'debounced'` and `debounceMs` on the consumer (the derivation or condition). For a field's own value commit timing, the Signal Forms substrate commits on every change — debouncing happens on the consumer side, not the field side.",
  },
  {
