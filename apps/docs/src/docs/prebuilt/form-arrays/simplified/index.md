...
description: Define dynamic form arrays with a concise template-based API. Auto-generated add/remove buttons, primitive and object arrays, size validation, and button customization.
---
