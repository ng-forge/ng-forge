...
- **[Input](/ui-integrations/material/text-input/input)** - For text-based number input
- **[Select](/ui-integrations/material/selection/select)** - For discrete value selection
