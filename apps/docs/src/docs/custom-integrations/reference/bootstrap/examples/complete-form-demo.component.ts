...
@Component({
  selector: 'app-complete-bootstrap-form',
  imports: [DynamicForm, JsonPipe, BootstrapDesignContainer],
  providers: [provideDynamicForm(...withBootstrapFields())],
  template: `
    <app-bootstrap-container>
      <h3>Complete Bootstrap Form Example</h3>
      <p>Comprehensive registration form showcasing all Bootstrap field types with validation.</p>
      <div class="row">
        <div class="col-lg-8">
...
export class CompleteBootstrapFormComponent {
  model = signal({
    firstName: '',
    lastName: '',
    email: '',
