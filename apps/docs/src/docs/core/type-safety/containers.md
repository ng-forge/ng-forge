...
- **[Type Safety Basics](/core-concepts/type-safety/basics)** - Getting started with type inference
- **[Custom Types](/core-concepts/type-safety/custom-types)** - Creating custom field types
- **[Form Layout](/form-layout/containers)** - Visual guide to container fields
- **[Validation](/core-concepts/validation/basics)** - Validating nested fields
