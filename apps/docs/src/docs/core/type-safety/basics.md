...
- **[Container Fields & Nesting](/core-concepts/type-safety/containers)** - Groups, rows, pages, and nesting rules
- **[Custom Types](/core-concepts/type-safety/custom-types)** - Extending the type system with custom fields
- **[Validation](/core-concepts/validation/basics)** - How validators affect inferred types
- **[Field Types](/core-concepts/field-types)** - Understanding available field types
