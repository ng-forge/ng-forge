...
description: 'Generate @ng-forge/dynamic-forms FormConfig objects and TypeScript interfaces from OpenAPI 3.x specifications.'
---
...
<docs-install-command packages="-D @ng-forge/openapi-generator"></docs-install-command>
