...
test.describe('Material Components Tests', () => {
  ...
  test.describe('Datepicker Component', () => {
    test('should open calendar and select date', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/datepicker-basic');
    ...
    test('should respect min/max date constraints', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/datepicker-constraints');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle required field validation', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/datepicker-validation');
      await page.waitForLoadState('networkidle');
    ...
    test('should clear date value', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/datepicker-clear');
      await page.waitForLoadState('networkidle');
    ...
    test('should be disabled when disabled prop is true', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/datepicker-disabled');
      await page.waitForLoadState('networkidle');
    ...
    test('should work with initial value', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/datepicker-initial-value');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Slider Component', () => {
    test('should update value on interaction', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/slider-basic');
      await page.waitForLoadState('networkidle');
    ...
    test('should respect min and max bounds', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/slider-bounds');
      await page.waitForLoadState('networkidle');
    ...
    test('should work with step increments', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/slider-steps');
      await page.waitForLoadState('networkidle');
    ...
    test('should be disabled when disabled prop is true', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/slider-disabled');
      await page.waitForLoadState('networkidle');
    ...
    test('should display current value', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/slider-value-display');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Toggle Component', () => {
    test('should change state on click', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/toggle-basic');
      await page.waitForLoadState('networkidle');
    ...
    test('should work with keyboard (Space/Enter)', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/toggle-keyboard');
      await page.waitForLoadState('networkidle');
    ...
    test('should be disabled when disabled prop is true', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/toggle-disabled');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle required toggle validation', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/toggle-validation');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Multi-Checkbox Component', () => {
    test('should select multiple options', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/multi-checkbox-basic');
      await page.waitForLoadState('networkidle');
    ...
    test('should collect values as array on submit', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/multi-checkbox-array');
      await page.waitForLoadState('networkidle');
    ...
    test('should deselect options', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/multi-checkbox-deselect');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle disabled options', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/multi-checkbox-disabled-options');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle required multi-checkbox validation', async ({ page, helpers }) => {
      await page.goto('/#/material/test/material-components/multi-checkbox-validation');
      await page.waitForLoadState('networkidle');
