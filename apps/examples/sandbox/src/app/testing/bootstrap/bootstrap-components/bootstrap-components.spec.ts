...
test.describe('Bootstrap Components Tests', () => {
  ...
  test.describe('Datepicker Component', () => {
    test('should open calendar and select date', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/datepicker-basic');
    ...
    test('should respect min/max date constraints', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/datepicker-constraints');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle required field validation', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/datepicker-validation');
      await page.waitForLoadState('networkidle');
    ...
    test('should clear date value', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/datepicker-clear');
      await page.waitForLoadState('networkidle');
    ...
    test('should be disabled when disabled prop is true', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/datepicker-disabled');
      await page.waitForLoadState('networkidle');
    ...
    test('should work with initial value', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/datepicker-initial-value');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Slider Component', () => {
    test('should update value on interaction', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/slider-basic');
      await page.waitForLoadState('networkidle');
    ...
    test('should respect min and max bounds', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/slider-bounds');
      await page.waitForLoadState('networkidle');
    ...
    test('should work with step increments', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/slider-steps');
      await page.waitForLoadState('networkidle');
    ...
    test('should be disabled when disabled prop is true', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/slider-disabled');
      await page.waitForLoadState('networkidle');
    ...
    test('should display current value', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/slider-value-display');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Toggle Component', () => {
    test('should change state on click', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/toggle-basic');
      await page.waitForLoadState('networkidle');
    ...
    test('should work with keyboard (Space/Enter)', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/toggle-keyboard');
      await page.waitForLoadState('networkidle');
    ...
    test('should be disabled when disabled prop is true', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/toggle-disabled');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle required toggle validation', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/toggle-validation');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Multi-Checkbox Component', () => {
    test('should select multiple options', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/multi-checkbox-basic');
      await page.waitForLoadState('networkidle');
    ...
    test('should collect values as array on submit', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/multi-checkbox-array');
      await page.waitForLoadState('networkidle');
    ...
    test('should deselect options', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/multi-checkbox-deselect');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle disabled options', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/multi-checkbox-disabled-options');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle required multi-checkbox validation', async ({ page, helpers }) => {
      await page.goto('/#/bootstrap/test/bootstrap-components/multi-checkbox-validation');
      await page.waitForLoadState('networkidle');
