...
test.describe('Demo Scenarios E2E Tests', () => {
  ...
  test.describe('User Registration', () => {
    test('should complete user registration form', async ({ page, helpers }) => {
      ...
      // Select country (PrimeNG p-select)
      await scenario.locator('#country p-select').click();
      await page.locator('.p-select-option').filter({ hasText: 'United States' }).click();
    ...
    test('should enforce minimum age validation', async ({ page, helpers }) => {
      ...
      // Select country (PrimeNG p-select)
      await scenario.locator('#country p-select').click();
      await page.locator('.p-select-option').filter({ hasText: 'Canada' }).click();
  ...
  test.describe('Profile Management', () => {
    ...
    test('should handle optional newsletter subscription', async ({ page, helpers }) => {
      ...
      // Check newsletter checkbox (PrimeNG p-checkbox)
      await scenario.locator('#newsletter p-checkbox').click();
  ...
  test.describe('Conditional Fields', () => {
    ...
    test('should submit form with cascading dropdowns', async ({ page, helpers }) => {
      ...
      // Select state (PrimeNG p-select)
      await scenario.locator('#state p-select').click();
      await page.locator('.p-select-option').filter({ hasText: 'California' }).click();
