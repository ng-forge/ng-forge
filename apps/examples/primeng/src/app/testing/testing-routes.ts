...
export default [
  ...
  // NOTE: Array Fields Tests are not available for PrimeNG because
  // 'addArrayItem' and 'removeArrayItem' field types are not implemented.
  // TODO: Implement these field types for PrimeNG if array manipulation is needed.
  ...
  // PrimeNG Components Tests - PrimeNG-specific component tests
  {
    ...
    loadChildren: () => import('./primeng-components/primeng-components.routes'),
  },
