...
test.describe('Form Reset and Clear Events Tests', () => {
  ...
  test.describe('Form Reset Functionality', () => {
    test('should reset form to default values', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/reset-defaults');
    ...
    test('should reset select fields to default values', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/reset-select');
      await page.waitForLoadState('networkidle');
      ...
      await expect(select.locator('.p-select-label')).toHaveText('United States', { timeout: 5000 });

      // Change to UK
      await helpers.selectOption(select, 'United Kingdom');

      // Verify changed value
      await expect(select.locator('.p-select-label')).toHaveText('United Kingdom', { timeout: 5000 });
    ...
    test('should reset checkbox fields to default values', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/reset-checkbox');
      await page.waitForLoadState('networkidle');
      ...
      await page.waitForSelector('[data-testid="reset-checkbox"] #subscribe input[type="checkbox"]', { state: 'visible', timeout: 10000 });
      await page.waitForSelector('[data-testid="reset-checkbox"] #terms input[type="checkbox"]', { state: 'visible', timeout: 10000 });
    ...
    test('should reset form validation state', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/reset-validation');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Form Clear Functionality', () => {
    test('should clear all form fields', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/clear-all');
      await page.waitForLoadState('networkidle');
    ...
    test('should clear select fields', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/clear-select');
      await page.waitForLoadState('networkidle');
      ...
      await expect(select.locator('.p-select-label')).toHaveText('Spanish', { timeout: 5000 });

      // Clear form
      await scenario.locator('#clear-button button').click();

      // Verify select is cleared (should not show Spanish)
      await expect(select.locator('.p-select-label')).not.toHaveText('Spanish', { timeout: 5000 });
    });

    test('should clear checkbox fields', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/clear-checkbox');
      await page.waitForLoadState('networkidle');
      ...
      await page.waitForSelector('[data-testid="clear-checkbox"] #subscribe input[type="checkbox"]', { state: 'visible', timeout: 10000 });
  ...
  test.describe('Reset vs Clear Behavior', () => {
    test('should differentiate between reset and clear actions', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/reset-vs-clear');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle reset and clear with required fields', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/required-reset-clear');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Complex Reset/Clear Scenarios', () => {
    test('should reset nested group fields', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/reset-nested');
      await page.waitForLoadState('networkidle');
    ...
    test('should handle multiple reset/clear cycles', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/form-reset-clear/multiple-cycles');
      await page.waitForLoadState('networkidle');
