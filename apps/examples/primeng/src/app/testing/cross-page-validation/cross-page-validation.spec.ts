...
test.describe('Cross-Page Validation Tests', () => {
  ...
  test.describe('Email Verification Flow', () => {
    test('should complete email verification across multiple pages', async ({ page, helpers }) => {
      ...
      await page.goto('http://localhost:4202/#/test/cross-page-validation/email-verification');
      ...
      await scenario.locator('#emailType p-radiobutton:has-text("Business Email")').click();
      ...
      await scenario.locator('#termsAgreement p-checkbox').click();
      await scenario.locator('#emailNotifications p-checkbox').click();
    ...
    test('should validate email confirmation matches primary email', async ({ page, helpers }) => {
      ...
      await scenario.locator('#emailType p-radiobutton:has-text("Personal Email")').click();
      await scenario.locator('button:has-text("Next"):visible').click();
      await page.waitForTimeout(300);
  ...
  test.describe('Conditional Pages Flow', () => {
    test('should navigate through individual account flow', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/cross-page-validation/conditional-pages');
      await page.waitForLoadState('networkidle');
      ...
      await scenario.locator('#accountType p-radiobutton:has-text("Individual Account")').click();
      await scenario.locator('#primaryUse').click();
      await page.locator('.p-select-overlay .p-select-option:has-text("Personal Use")').click();
      await page.waitForTimeout(200);
      ...
      await scenario.locator('#finalTerms p-checkbox').click();
      await page.waitForTimeout(200);
    ...
    test('should navigate through business account flow', async ({ page, helpers }) => {
      ...
      await scenario.locator('#accountType p-radiobutton:has-text("Business Account")').click();
      await scenario.locator('#primaryUse').click();
      await page.locator('.p-select-overlay .p-select-option:has-text("Professional Use")').click();
      await page.waitForTimeout(200);
      ...
      await page.locator('.p-select-overlay .p-select-option:has-text("LLC")').click();
      await page.waitForTimeout(200);
  ...
  test.describe('Business Flow', () => {
    test('should validate Tax ID format', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/cross-page-validation/business-flow');
      await page.waitForLoadState('networkidle');
  ...
  test.describe('Cascade Dependencies Flow', () => {
    test('should maintain consistent data across pages', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/cross-page-validation/cascade-dependencies');
      await page.waitForLoadState('networkidle');
      ...
      await page.locator('.p-select-overlay .p-select-option:has-text("Canada")').click();

      await scenario.locator('#language').click();
      await page.locator('.p-select-overlay .p-select-option:has-text("English")').click();

      await scenario.locator('#currency').click();
      await page.locator('.p-select-overlay .p-select-option:has-text("Canadian Dollar (CAD)")').click();
      await page.waitForTimeout(200);
      ...
      await page.locator('.p-select-overlay .p-select-option:has-text("Ontario")').click();
      await page.waitForTimeout(200);
      ...
      await scenario.locator('#paymentMethod p-radiobutton:has-text("Bank Transfer")').click();
  ...
  test.describe('Progressive Validation Flow', () => {
    test('should enforce validation at each page level', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/cross-page-validation/progressive-validation');
      await page.waitForLoadState('networkidle');
      ...
      await page.locator('.p-select-overlay .p-select-option:has-text("What was your first pet\'s name?")').click();
    ...
    test('should validate username confirmation matches original', async ({ page, helpers }) => {
      ...
      await scenario.locator('#securityQuestion').click();
      await page.locator('.p-select-overlay .p-select-option:has-text("What was your first school?")').click();
