...
test.describe('Conditional Fields E2E Tests', () => {
  ...
  test('should toggle conditional address fields based on checkbox', async ({ page, helpers }) => {
    ...
    await expect(hasAddressCheckbox).not.toHaveClass(/p-checkbox-checked/);
    ...
    await expect(hasAddressCheckbox).toHaveClass(/p-checkbox-checked/);
    ...
    await expect(scenario.locator('#country p-select')).toBeVisible();
