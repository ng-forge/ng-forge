...
test.describe('Cross-Field Validation Tests', () => {
  ...
  test.describe('Password Confirmation Validation', () => {
    test('should validate password matching', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/cross-field-validation/password-validation');
  ...
  test.describe('Conditional Required Fields', () => {
    test('should handle conditional field requirements', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/cross-field-validation/conditional-fields');
      await page.waitForLoadState('networkidle');
      ...
      const hasAddressCheckbox = scenario.locator('#hasAddress p-checkbox');
      ...
      // Select country
      await scenario.locator('#country p-select').click();
      await page.locator('.p-select-overlay .p-select-option').filter({ hasText: 'United States' }).click();
      await page.waitForTimeout(300);
  ...
  test.describe('Dependent Select Fields', () => {
    test('should handle dependent field selections', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/cross-field-validation/dependent-fields');
      await page.waitForLoadState('networkidle');
      ...
      const categorySelect = scenario.locator('#category p-select');
      const subcategorySelect = scenario.locator('#subcategory p-select');
      const productNameInput = scenario.locator('#productName input');
      const priceInput = scenario.locator('#price input');
      const currencySelect = scenario.locator('#currency p-select');
      ...
      await page.locator('.p-select-overlay .p-select-option').filter({ hasText: 'Electronics' }).click();
      await page.waitForTimeout(300);

      // Select laptop subcategory
      await subcategorySelect.click();
      await page.locator('.p-select-overlay .p-select-option').filter({ hasText: 'Laptop' }).click();
      await page.waitForTimeout(300);
      ...
      await page.locator('.p-select-overlay .p-select-option').filter({ hasText: 'EUR' }).click();
      await page.waitForTimeout(300);
      ...
      await categorySelect.click();
      await page.locator('.p-select-overlay .p-select-option').filter({ hasText: 'Clothing' }).click();
      await page.waitForTimeout(300);

      // Change subcategory
      await subcategorySelect.click();
      await page.locator('.p-select-overlay .p-select-option').filter({ hasText: 'Shirt' }).click();
      await page.waitForTimeout(300);
  ...
  test.describe('Field Enable/Disable', () => {
    test('should handle field enabling/disabling based on selections', async ({ page, helpers }) => {
      await page.goto('http://localhost:4202/#/test/cross-field-validation/enable-disable');
      await page.waitForLoadState('networkidle');
      ...
      const standardShippingRadio = scenario.locator('#shippingMethod p-radiobutton').filter({ hasText: 'Standard' });
      const expressShippingRadio = scenario.locator('#shippingMethod p-radiobutton').filter({ hasText: 'Express' });
      const pickupRadio = scenario.locator('#shippingMethod p-radiobutton').filter({ hasText: 'Store Pickup' });
      ...
      await scenario.locator('#storeLocation p-select').click();
      await page.locator('.p-select-overlay .p-select-option').filter({ hasText: 'Downtown Store' }).click();
      await page.waitForTimeout(300);
