...
module.exports = withNativeFederation({
  ...
  exposes: {
    './routes': 'apps/examples/material/src/app/remote-entry.ts',
  },
  ...
  shared: {
    ...
    '@ng-forge/dynamic-forms-material': {
      ...
      requiredVersion: 'auto',
      packageInfo: {
        entryPoint: path.resolve(__dirname, '../../../dist/packages/dynamic-forms-material/fesm2022/ng-forge-dynamic-forms-material.mjs'),
        version: '0.0.1',
        esm: true,
      },
    },
