...
test.describe('Array Fields E2E Tests', () => {
  ...
  test.describe('Conditional Visibility', () => {
    ...
    // TODO: This test scenario needs to be redesigned - it uses hardcoded field paths (addresses.0.hasApartment)
    // instead of relative paths, causing all items to depend on the first item's fields.
    // Also has a runtime error when adding items due to checkbox mapper failing to resolve field trees.
    test.skip('should handle conditional fields within array items', async ({ page, helpers }) => {
