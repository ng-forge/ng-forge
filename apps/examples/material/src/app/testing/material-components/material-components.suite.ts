...
export const materialComponentsSuite: TestSuite = {
  id: 'material-components',
  title: 'Material Components',
  description: 'Testing material-specific components (datepicker, slider, toggle, multi-checkbox)',
...
export function getMaterialComponentsScenario(testId: string) {
  return materialComponentsSuite.scenarios.find((s) => s.testId === testId);
}
