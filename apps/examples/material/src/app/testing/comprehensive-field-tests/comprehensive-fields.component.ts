...
@Component({
  ...
  template: `
    <div class="test-page">
      <h1>Comprehensive Field Testing</h1>
      <section class="test-scenario" data-testid="comprehensive-fields">
        <h2 data-testid="comprehensive-fields-title">Comprehensive Field Testing</h2>
        <p class="scenario-description">Testing all available Material Design field types</p>
        <dynamic-form [config]="config" [(value)]="value" (submitted)="onSubmitted($event)" />

        <details class="debug-output form-state">
          <summary>Debug Output</summary>
          <pre [attr.data-testid]="'form-value-comprehensive-fields'">{{ value() | json }}</pre>
...
export class ComprehensiveFieldsTestComponent {
  ...
  onSubmitted(value: Record<string, unknown> | undefined): void {
    ...
    window.dispatchEvent(new CustomEvent('formSubmitted', { detail: { ...submission, testId: 'comprehensive-fields' } }));
  }
}
