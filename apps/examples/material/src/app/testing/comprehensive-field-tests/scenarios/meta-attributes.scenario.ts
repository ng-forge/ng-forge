...
const config = {
  fields: [
    ...
    // Input with meta (for comparison with native element behavior)
    {
      key: 'emailInput',
      type: 'input',
      label: 'Email',
...
export const metaAttributesScenario: TestScenario = {
  testId: 'meta-attributes-test',
  title: 'Meta Attributes Testing',
  description: 'Testing meta attribute propagation to native input elements in wrapped components',
  config,
};
