...
test.describe('Cross-Page Validation Tests', () => {
  test.beforeEach(async ({ helpers }) => {
    await helpers.navigateToScenario('/testing/cross-page-validation');
  });
  ...
  test.describe('Email Verification Flow', () => {
    test('should complete email verification across multiple pages', async ({ page, helpers }) => {
      ...
      await page.goto('/#/cross-page-validation/email-verification');
      ...
      await ionBlur(primaryEmailInput);
      await helpers.selectRadio(scenario, 'emailType', 'Business Email');

      // Navigate to page 2
      await scenario.locator('ion-button:has-text("Next"):visible').click();
      ...
      await ionBlur(confirmEmailInput);

      const termsCheckbox = scenario.locator('#termsAgreement ion-checkbox');
      await helpers.checkIonCheckbox(termsCheckbox);
      await expect(termsCheckbox).toBeChecked({ timeout: 5000 });

      const notificationsCheckbox = scenario.locator('#emailNotifications ion-checkbox');
      await helpers.checkIonCheckbox(notificationsCheckbox);
      ...
      await page.waitForSelector(
        '[data-testid="cross-page-email-verification"] #submitEmailVerification ion-button:not([aria-disabled="true"])',
        {
          state: 'visible',
          timeout: 10000,
        },
      );
      const submitButton = scenario.locator('#submitEmailVerification ion-button');
  ...
  test.describe('Conditional Pages Flow', () => {
    test('should navigate through individual account flow', async ({ page, helpers }) => {
      await page.goto('/#/cross-page-validation/conditional-pages');
      await page.waitForLoadState('networkidle');
      ...
      await helpers.selectOption(scenario.locator('#primaryUse ion-select'), 'Personal Use');
      ...
      await ionBlur(confirmationCodeInput);

      const finalTermsCheckbox = scenario.locator('#finalTerms ion-checkbox');
      await helpers.checkIonCheckbox(finalTermsCheckbox);
      ...
      // Wait for submit button to be enabled
      await page.waitForSelector('[data-testid="conditional-pages"] #submitConditional ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });
    ...
    test('should navigate through business account flow', async ({ page, helpers }) => {
      ...
      await helpers.selectOption(scenario.locator('#primaryUse ion-select'), 'Professional Use');
      ...
      await ionBlur(businessNameInput);
      ...
      await ionBlur(taxIdInput);

      await helpers.selectOption(scenario.locator('#businessType ion-select'), 'LLC');
  ...
  test.describe('Business Flow', () => {
    test('should validate Tax ID format', async ({ page, helpers }) => {
      await page.goto('/#/cross-page-validation/business-flow');
      await page.waitForLoadState('networkidle');
      ...
      const taxIdInput = scenario.locator('#taxId input');
      const submitButton = scenario.locator('#submitBusiness ion-button');
      ...
      const nextButton = scenario.locator('ion-button:has-text("Next"):visible');
      await expect(nextButton).toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
      ...
      // Wait for submit button to be enabled
      await page.waitForSelector('[data-testid="business-flow"] #submitBusiness ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });
      await expect(submitButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
  ...
  test.describe('Cascade Dependencies Flow', () => {
    test('should maintain consistent data across pages', async ({ page, helpers }) => {
      await page.goto('/#/cross-page-validation/cascade-dependencies');
      await page.waitForLoadState('networkidle');
      ...
      await helpers.selectOption(scenario.locator('#currency ion-select'), 'Canadian Dollar (CAD)');
      ...
      await ionBlur(postalCodeInput);

      await helpers.selectOption(scenario.locator('#stateProvince ion-select'), 'Ontario');
      ...
      await helpers.selectOption(scenario.locator('#bankCountry ion-select'), 'Canada');
      ...
      // Wait for submit button to be enabled
      await page.waitForSelector('[data-testid="cascade-dependencies"] #submitCascade ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });
      const submitButton = scenario.locator('#submitCascade ion-button');
      await expect(submitButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
  ...
  test.describe('Progressive Validation Flow', () => {
    test('should enforce validation at each page level', async ({ page, helpers }) => {
      await page.goto('/#/cross-page-validation/progressive-validation');
      await page.waitForLoadState('networkidle');
      ...
      const page2NextButton = scenario.locator('ion-button:has-text("Next"):visible');
      ...
      await expect(page2NextButton).toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
      ...
      // Now Next button should be enabled
      await expect(page2NextButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
      ...
      await ionBlur(confirmUsernameInput);
      ...
      await ionBlur(verificationCodeInput);
      ...
      // Wait for submit button to be enabled
      await page.waitForSelector('[data-testid="progressive-validation"] #submitProgressive ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });
      const submitButton = scenario.locator('#submitProgressive ion-button');
      await expect(submitButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
    ...
    test('should validate username confirmation matches original', async ({ page, helpers }) => {
      ...
      await helpers.selectOption(scenario.locator('#securityQuestion ion-select'), 'What was your first school?');
