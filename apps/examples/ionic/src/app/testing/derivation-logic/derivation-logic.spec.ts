...
test.describe('Value Derivation Logic Tests', () => {
  test.describe('Static Value Derivation', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(testUrl('/derivation-logic/static-value'));
  ...
  test.describe('Expression-Based Derivation', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(testUrl('/derivation-logic/expression'));
      await page.waitForLoadState('networkidle');
    });
  ...
  test.describe('Function-Based Derivation', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(testUrl('/derivation-logic/function'));
      await page.waitForLoadState('networkidle');
    });
  ...
  test.describe('Conditional Derivation', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(testUrl('/derivation-logic/conditional'));
      await page.waitForLoadState('networkidle');
    });
    ...
    test('should derive discount percentage and free shipping based on membership type', async ({ page, helpers }) => {
      ...
      // Ionic toggle is an ion-toggle element
      const freeShippingToggle = scenario.locator('#freeShipping ion-toggle');
  ...
  test.describe('Self-Transform Derivation (Debounced)', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(testUrl('/derivation-logic/self-transform'));
      await page.waitForLoadState('networkidle');
    });
  ...
  test.describe('Chain Derivation (A -> B -> C)', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(testUrl('/derivation-logic/chain'));
      await page.waitForLoadState('networkidle');
    });
  ...
  test.describe('Shorthand Derivation Property', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(testUrl('/derivation-logic/shorthand'));
      await page.waitForLoadState('networkidle');
    });
  ...
  test.describe('Array Field Derivation with Relative Paths', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(testUrl('/derivation-logic/array-field'));
      await page.waitForLoadState('networkidle');
    });
