...
test.describe('Submission Behavior Tests', () => {
  test.describe('Basic Submission', () => {
    ...
    test('should disable submit button while form is submitting', async ({ page, helpers }) => {
      ...
      await page.waitForSelector('[data-testid="basic-submission"] #submitForm ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });

      // Get the submit button
      const submitButton = scenario.locator('#submitForm ion-button');
    ...
    test('should increment submission count on successful submission', async ({ page, helpers, mockApi }) => {
      ...
      // Submit the form
      await scenario.locator('#submitForm ion-button').click();
  ...
  test.describe('Button Disabled When Invalid', () => {
    ...
    test('should disable submit button when form is invalid', async ({ page, helpers }) => {
      ...
      // Wait for submit button to be enabled
      await page.waitForSelector('[data-testid="button-disabled-invalid"] #submitInvalid ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });
  ...
  test.describe('Button Disabled While Submitting', () => {
    ...
    test('should disable submit button during submission', async ({ page, helpers }) => {
      ...
      await page.waitForSelector('[data-testid="button-disabled-submitting"] #submitSubmitting ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });

      const submitButton = scenario.locator('#submitSubmitting ion-button');
      await expect(submitButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
  ...
  test.describe('Button Never Disabled', () => {
    ...
    test('should allow submit button to stay enabled with custom options', async ({ page, helpers }) => {
      ...
      const submitButton = scenario.locator('#submitNeverDisabled ion-button');
      await expect(submitButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
  ...
  test.describe('Next Button Page Validation', () => {
    ...
    test('should disable next button when page is invalid', async ({ page, helpers }) => {
      ...
      await page.waitForSelector('[data-testid="next-button-page-validation"] #nextToPage2 ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });
  ...
  test.describe('Next Button Never Disabled', () => {
    ...
    test('should allow next button to stay enabled with custom options', async ({ page, helpers }) => {
      ...
      const nextButton = scenario.locator('#nextToPage2b ion-button');
      await expect(nextButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
  ...
  test.describe('FormStateCondition Logic', () => {
    ...
    test('should use FormStateCondition for disabled logic', async ({ page, helpers }) => {
      ...
      // Wait for submit button to be enabled (form is pre-filled with valid data)
      await page.waitForSelector('[data-testid="form-state-condition"] #submitFormState ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });

      const submitButton = scenario.locator('#submitFormState ion-button');
      await expect(submitButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
  ...
  test.describe('Conditional Expression Logic', () => {
    ...
    test('should use conditional expression for disabled logic', async ({ page, helpers }) => {
      ...
      // Wait for fields to be ready - Ionic checkbox uses ion-checkbox, not native input
      await page.waitForSelector('[data-testid="conditional-expression"] #disableSubmit ion-checkbox', {
        state: 'visible',
        timeout: 10000,
      });
      ...
      // Ionic checkbox
      const checkbox = helpers.getCheckbox(scenario, 'disableSubmit');
      ...
      await helpers.uncheckIonCheckbox(checkbox);
  ...
  test.describe('Explicit Disabled', () => {
    ...
    test('should always disable button with explicit disabled: true', async ({ page, helpers }) => {
      ...
      const submitButton = scenario.locator('#submitExplicit ion-button');
      await expect(submitButton).toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
  ...
  test.describe('HTTP Error Handling', () => {
    ...
    test('should submit form via HTTP and show success', async ({ page, helpers, mockApi }) => {
      ...
      await ionBlur(messageInput);

      // Wait for submit button to be enabled
      await page.waitForSelector('[data-testid="http-error-handling"] #submitErrorTest ion-button:not([aria-disabled="true"])', {
        state: 'visible',
        timeout: 10000,
      });

      // Get the submit button
      const submitButton = scenario.locator('#submitErrorTest ion-button');
      await expect(submitButton).not.toHaveAttribute('aria-disabled', 'true', { timeout: 10000 });
