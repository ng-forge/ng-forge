...
module.exports = withNativeFederation({
  ...
  exposes: {
    './routes': 'apps/examples/ionic/src/app/remote-entry.ts',
  },
  ...
  shared: {
    ...
    '@ng-forge/dynamic-forms-ionic': {
      ...
      requiredVersion: 'auto',
      packageInfo: {
        entryPoint: path.resolve(__dirname, '../../../dist/packages/dynamic-forms-ionic/fesm2022/ng-forge-dynamic-forms-ionic.mjs'),
        version: '0.0.1',
        esm: true,
      },
    },
