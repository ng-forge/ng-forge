...
import { allFieldsAriaScenario } from './scenarios/all-fields-aria.scenario';
...
export const accessibilitySuite: TestSuite = {
  ...
  scenarios: [
    ariaAttributesScenario,
    allFieldsAriaScenario,
    errorAnnouncementsScenario,
    keyboardNavigationScenario,
    focusManagementScenario,
  ],
};
