...
import { agentConfigSwapScenario } from './scenarios/agent-config-swap.scenario';
...
export const webMcpSuite: TestSuite = {
  ...
  path: '/test/web-mcp',
  scenarios: [agentFillSubmitScenario, agentFillOnlyScenario, agentConfigSwapScenario],
};
