...
`@ng-forge/dynamic-forms-material` provides a complete set of Material Design field components for ng-forge. Built with Angular Material, these components offer beautiful, accessible, and production-ready form controls.
...
yarn add @ng-forge/dynamic-forms @ng-forge/dynamic-forms-material @angular/material
```

```bash group="install" name="pnpm"
pnpm add @ng-forge/dynamic-forms @ng-forge/dynamic-forms-material @angular/material
```
...
```typescript
import { nextPageButton, previousPageButton } from '@ng-forge/dynamic-forms-material';
...
```typescript
import { actionButton } from '@ng-forge/dynamic-forms-material';
