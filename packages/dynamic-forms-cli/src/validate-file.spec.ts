...
import { formatConfigReport, formatFileReport } from './report.js';
...
describe('report formatting', () => {
  ...
  it('includes fix suggestions and doc links for a failing file report', () => {
    const result = validateSource(INVALID_SOURCE, '/tmp/broken.form.ts', 'material');
    const report = formatFileReport(result, { relatedDocs: collectRelatedDocs });
