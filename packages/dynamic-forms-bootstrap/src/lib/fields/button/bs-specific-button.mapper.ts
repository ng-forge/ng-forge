...
import { BsAddArrayItemButtonField, BsRemoveArrayItemButtonField } from './bs-button.type';
 ...
 */
export function addArrayItemButtonFieldMapper(fieldDef: BsAddArrayItemButtonField): Binding[] {
  const bindings: Binding[] = baseFieldMapper(fieldDef);
 ...
 */
export function removeArrayItemButtonFieldMapper(fieldDef: BsRemoveArrayItemButtonField): Binding[] {
  const bindings: Binding[] = baseFieldMapper(fieldDef);
