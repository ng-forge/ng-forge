 ...
 */
export interface GroupField<TFields extends Record<string, FieldDef<Record<string, unknown>>>> extends FieldDef<never> {
...
export function isGroupField<TFields extends Record<string, FieldDef<Record<string, unknown>>>>(
  field: FieldDef<Record<string, unknown>>
): field is GroupField<TFields> {
  return field.type === 'group' && 'fields' in field;
}

export type GroupComponent<T extends Record<string, FieldDef<Record<string, unknown>>>> = FieldComponent<GroupField<T>>;
