...
describe('generateBarrel', () => {
  ...
  it('should use custom empty extension when provided', () => {
    const result = generateBarrel(['create-pet.form.ts'], { extension: '' });

    expect(result).toContain("export * from './create-pet.form';");
  });

  it('should default to .js extension when no options provided', () => {
