...
import { PrimeAddArrayItemButtonField, PrimeRemoveArrayItemButtonField } from './prime-button.type';
 ...
 */
export function addArrayItemButtonFieldMapper(fieldDef: PrimeAddArrayItemButtonField): Binding[] {
  const bindings: Binding[] = baseFieldMapper(fieldDef);
 ...
 */
export function removeArrayItemButtonFieldMapper(fieldDef: PrimeRemoveArrayItemButtonField): Binding[] {
  const bindings: Binding[] = baseFieldMapper(fieldDef);
