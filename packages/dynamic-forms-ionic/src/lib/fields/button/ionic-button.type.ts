...
export interface IonicAddArrayItemButtonField extends Omit<FieldDef<IonicButtonProps>, 'event'> {
  type: 'addArrayItem';
  key: string;
  label: string;
  disabled?: boolean;
...
export interface IonicRemoveArrayItemButtonField extends Omit<FieldDef<IonicButtonProps>, 'event'> {
